...
return [
    ...
    */
    ...
    // ── PPR (eau chaude et eau froide sous pression) ─────────────────────
    [
        'slug' => 'tube-ppr-pn20-25-4m',
        'name' => 'Tube PPR PN20 Ø25 barre de 4 m',
        'category' => 'tuyauterie',
        'description' => "Tube polypropylène random PN20, Ø25 mm, barre de 4 mètres. Le PPR se soude par polyfusion : le tube et le raccord fondent ensemble et ne forment plus qu'une seule pièce, sans joint ni colle susceptible de lâcher. Supporte l'eau chaude sanitaire en continu, ce que le PVC pression ne fait pas. Vert, opaque aux UV.",
        'price' => 5500,
        'old_price' => null,
        'badge' => null,
        'stock' => 60,
        'tiers' => [[1, 9, 5500], [10, 49, 4950], [50, null, 4400]],
        'photos' => [],
    ],
    [
        'slug' => 'coude-ppr-male-filete-25-34',
        'name' => 'Coude PPR mâle fileté 25 x 3/4"',
        'category' => 'tuyauterie',
        'description' => "Coude PPR à 90°, une sortie à souder Ø25 mm et une sortie mâle filetée 3/4\" avec insert laiton noyé. Fait la transition entre un réseau PPR soudé et un élément fileté : robinet, compteur, flexible. L'insert laiton est moulé dans la masse, il ne tourne pas au serrage.",
        'price' => 1200,
        'old_price' => null,
        'badge' => null,
        'stock' => 140,
        'tiers' => [[1, 19, 1200], [20, 99, 1050], [100, null, 900]],
        'photos' => [],
    ],
    [
        'slug' => 'coude-ppr-male-filete-32-34',
        'name' => 'Coude PPR mâle fileté 32 x 3/4"',
        'category' => 'tuyauterie',
        'description' => "Coude PPR à 90°, sortie à souder Ø32 mm et sortie mâle filetée 3/4\" à insert laiton. Le diamètre des colonnes montantes et des alimentations principales, là où le Ø25 dessert les antennes. Soudure par polyfusion d'un côté, raccordement fileté de l'autre.",
        'price' => 1800,
        'old_price' => null,
        'badge' => null,
        'stock' => 120,
    ...
    [
        'slug' => 'coude-ppr-femelle-filete-32-34',
        'name' => 'Coude PPR femelle fileté 32 x 3/4"',
        'category' => 'tuyauterie',
        'description' => 'Coude PPR à 90°, sortie à souder Ø32 mm et sortie femelle filetée 3/4" à insert laiton. Le pendant du modèle mâle : il reçoit un élément fileté mâle — mamelon, sortie de chauffe-eau, nez de vanne. Insert laiton noyé dans la masse.',
        'price' => 1800,
        'old_price' => null,
        'badge' => null,
        'stock' => 120,
    ...
    [
        'slug' => 'robinet-arret-ppr-volant-32',
        'name' => 'Robinet d’arrêt PPR à volant Ø32',
        'category' => 'vannes',
        'description' => "Robinet d'arrêt PPR à volant, Ø32 mm à souder des deux côtés. Se pose en tête de colonne ou en entrée d'appartement pour isoler une partie du réseau sans couper toute la maison. Corps PPR soudé par polyfusion, tête à clapet démontable pour changer le joint sans déposer le robinet.",
        'price' => 6500,
        'old_price' => null,
        'badge' => null,
        'stock' => 50,
    ...
    [
        ...
        'name' => 'Vanne PPR DN25',
        'category' => 'vannes',
        'description' => "Vanne PPR DN25 à souder, quart de tour. Coupure franche d'une antenne PPR sans raccord fileté intermédiaire — donc sans point de fuite potentiel. Poignée repérable d'un coup d'œil sur la position ouverte ou fermée.",
        'price' => 5500,
        'old_price' => null,
        'badge' => null,
        'stock' => 55,
    ...
    // ── PVC évacuation : compléments ─────────────────────────────────────
    [
        'slug' => 'tube-pvc-evacuation-100-4m',
        'name' => 'Tube PVC évacuation Ø100 barre de 4 m',
        'category' => 'evacuation',
        'description' => "Tube PVC d'évacuation Ø100 mm, barre de 4 mètres, teinte grise. Le diamètre des chutes d'eaux usées et des raccordements de cuvette WC. Paroi lisse qui limite les dépôts, se recoupe à la scie à denture fine et s'ébavure au couteau avant collage.",
        'price' => 8500,
        'old_price' => null,
        'badge' => null,
        'stock' => 45,
        'tiers' => [[1, 9, 8500], [10, 49, 7650], [50, null, 6800]],
        'photos' => [],
    ],
    [
        'slug' => 'coude-pvc-evacuation-45-mf-100',
        'name' => 'Coude PVC évacuation 45° mâle-femelle Ø100',
        'category' => 'evacuation',
        'description' => "Coude PVC d'évacuation à 45°, Ø100 mm, une extrémité mâle et une femelle. Le bout mâle s'emboîte directement dans le tube suivant : un raccord de moins qu'avec un coude femelle-femelle. L'angle à 45° accompagne l'écoulement au lieu de le freiner.",
        'price' => 2500,
        'old_price' => null,
        'badge' => null,
        'stock' => 85,
    ...
    [
        'slug' => 'coude-pvc-evacuation-45-ff-100',
        'name' => 'Coude PVC évacuation 45° femelle-femelle Ø100',
        'category' => 'evacuation',
        'description' => "Coude PVC d'évacuation à 45°, Ø100 mm, deux emboîtements femelles. S'intercale entre deux tubes déjà coupés, sans avoir à conserver un bout mâle. Le complément du modèle mâle-femelle selon la configuration du chantier.",
        'price' => 2400,
        'old_price' => null,
        'badge' => null,
        'stock' => 85,
        'tiers' => [[1, 9, 2400], [10, 49, 2120], [50, null, 1850]],
        'photos' => [],
    ],
    [
        'slug' => 'coude-pvc-evacuation-ff-40',
        'name' => 'Coude PVC évacuation femelle-femelle Ø40',
        'category' => 'evacuation',
        'description' => "Coude PVC d'évacuation Ø40 mm, deux emboîtements femelles, à coller. Le diamètre des évacuations de lavabo, d'évier et de bac à douche. Deux femelles pour raccorder deux tronçons coupés bout à bout.",
        'price' => 800,
        'old_price' => null,
        'badge' => null,
        'stock' => 180,
        'tiers' => [[1, 19, 800], [20, 99, 700], [100, null, 600]],
        'photos' => [],
    ],

    // ── Colles : grand format ────────────────────────────────────────────
    [
        'slug' => 'colle-pvc-pegafort-1kg',
        'name' => 'Colle PVC Pegafort boîte 1 kg',
        'category' => 'colles-soudures',
        'description' => "Colle PVC Pegafort en boîte métal de 1 kg, avec pinceau applicateur. Le format chantier : de quoi coller une installation complète sans rouvrir dix petits pots, qui sèchent dès qu'ils traînent. Prise rapide sur PVC rigide, pression comme évacuation. Refermer soigneusement après usage.",
        'price' => 12000,
        'old_price' => null,
        'badge' => 'Chantier',
        'stock' => 30,
        'tiers' => [[1, 4, 12000], [5, 19, 11000], [20, null, 10000]],
        'photos' => [],
    ],
